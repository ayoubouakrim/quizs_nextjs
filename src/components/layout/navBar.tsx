                ...
                <div className="flex items-center justify-between h-14">
                    ...
                    <div className="flex items-center">
                        <div className="flex-shrink-0 flex items-center group">
                            <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-1.5 rounded-lg mr-3 group-hover:from-blue-600 group-hover:to-blue-700 transition-all duration-300">
                                <GraduationCap className="h-5 w-5 text-white" />
                            </div>
                            <span className="text-gray-800 text-lg font-bold tracking-tight">EduAI</span>
                        </div>
                    </div>
                        ...
                        <div className="ml-10 flex items-center space-x-1">
                            ...
                            <div className="relative">
                                ...
                                {activeDropdown === 'aitools' && (
                                    <div className="absolute left-0 mt-2 w-48 rounded-xl shadow-lg bg-white ring-1 ring-gray-100 backdrop-blur-sm">
                                        <div className="py-2">
                                            <a href="/quiz-generator" className="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-200 group">
                                                <FileText className="h-4 w-4 mr-3 group-hover:scale-110 transition-transform duration-200" />
                                                Quiz Generator
                                            </a>
                                            <a href="/summarizer" className="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-200 group">
                                                <BookOpen className="h-4 w-4 mr-3 group-hover:scale-110 transition-transform duration-200" />
                                                Summarizer
                                            </a>
                                            <a href="/exercises" className="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-200 group">
                        ...
                        <div className="ml-4 flex items-center space-x-2">
                            ...
                            <div className="relative">
                                ...
                                {activeDropdown === 'profile' && (
                                    <div className="origin-top-right absolute right-0 mt-2 w-48 rounded-xl shadow-lg bg-white ring-1 ring-gray-100 backdrop-blur-sm">
                                        <div className="py-2">
                                            <a href="/profile" className="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-200 group">
                                                <User className="h-4 w-4 mr-3 group-hover:scale-110 transition-transform duration-200" />
                                                Your Profile
                                            </a>
                                            <a href="/settings" className="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-200 group">
                                                <Settings className="h-4 w-4 mr-3 group-hover:scale-110 transition-transform duration-200" />
                                                Settings
                                            </a>
                                            <div className="border-t border-gray-100 my-1"></div>
                                            <a href="/logout" className="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-red-50 hover:text-red-600 transition-colors duration-200">
                                                Sign out
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div className="px-4 pt-3 pb-4 space-y-2">
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="ml-6 space-y-1">
                                <a href="/quiz-generator" className="text-gray-500 hover:text-blue-600 hover:bg-blue-50 block px-3 py-2 rounded-lg text-sm font-medium flex items-center transition-all duration-200 group">
                                    <FileText className="h-4 w-4 mr-3 group-hover:scale-110 transition-transform duration-200" />
                                    Quiz Generator
                                </a>
                                <a href="/summarizer" className="text-gray-500 hover:text-blue-600 hover:bg-blue-50 block px-3 py-2 rounded-lg text-sm font-medium flex items-center transition-all duration-200 group">
                                    <BookOpen className="h-4 w-4 mr-3 group-hover:scale-110 transition-transform duration-200" />
                                    Summarizer
                                </a>
                                <a href="/exercises" className="text-gray-500 hover:text-blue-600 hover:bg-blue-50 block px-3 py-2 rounded-lg text-sm font-medium flex items-center transition-all duration-200 group">
                                    <Zap className="h-4 w-4 mr-3 group-hover:scale-110 transition-transform duration-200" />
                                    Exercise Builder
                                </a>
                            </div>
